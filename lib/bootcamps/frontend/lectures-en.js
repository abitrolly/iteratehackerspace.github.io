...
about layout or styling.`
     ...
     {title: 'Inline Styling in React',
      content: [
        `Here we will attach JS Objects to Components`
      ]},
     {title: 'Flexbox overview',
      content: [
        `Display`
      ]},
     {title: 'More flexbox overview',
      content: [
        `blah blah`
      ]},
     {title: 'CSS in JS',
      content: [
        `Talk about CSS in JS`
      ]},
  ...
  {name: 'Routing',
   ...
   slides: [
     {title:'SPAs',
      content: [
        `SPAs stand for Single-Page-Application`
      ]
     }
   ]},
